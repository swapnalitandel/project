...
<div class="container">
<header>
<img src="login.jpg" height=30% width=100%>
...
<li><a class="active" href="Doctor.jsp">Search Doctor</a></li>
<li><a class="active" href="Fd.html">Feedback</a></li>
...
<form  action="Admin" > 
<center><h1 color="black" >VIEW DOCTOR </h1></center>
...
try
{
	...
	Class.forName("oracle.jdbc.OracleDriver");
	 ...
	 st=conn.createStatement();
	 String qry="select * from doctor5";
